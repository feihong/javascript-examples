...
BLOG_AUTHOR = "Feihong Hsu"  # (translatable)
BLOG_TITLE = "Feihong's JavaScript Examples"  # (translatable)
# This is the main URL for your site. It will be used
# in a prominent link. Don't forget the protocol (http/https)!
SITE_URL = "http://feihong.github.io/javascript-examples/"
# This is the URL where Nikola's output will be deployed.
# If not set, defaults to SITE_URL
# BASE_URL = "http://feihong.github.io/javascript-examples/"
BLOG_EMAIL = "feihong.hsu@gmail.com"
BLOG_DESCRIPTION = "JavaScript examples written by Feihong Hsu"  # (translatable)
